            ...
            <div class="panels-container">
                ...
                <section>
                        <nav class="navSecondary">
                            <a href="#!" class="btn btn-secondary btn-lg" role="button" aria-pressed="true"
                                data-target="#eventosativos">Ativos</a>
                            <a href="#!" class="btn btn-secondary btn-lg" role="button" aria-pressed="true"
                                data-target="#eventosencerrados">Encerrados</a>
                        </nav>
                    </div>
                </section>
                ...
                {{-- Eventos adicionado para representação --}}
                <section class="grid">
                    <main>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <input type="text" class="form-control inputtext" id="validarpresenca" name="email"
                            ...
                            <div class="modal-footer">
                                <small>Atenção! Se o código estiver fora do prazo nada será validado.</small>
                ...
                <div class="modal fade" id="cancelarpresenca" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <div class="modal-cancelapresenca">
                                    <button id="confirmacancelamento" type="button" class="btn btn-warning">
                                        <i class="fa fa-check-circle">&nbsp;</i>Sim
                                    </button>
                                    <button id="abortacancelamento" type="button" class="btn btn-info">

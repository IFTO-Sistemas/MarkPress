                ...
                <form method="POST" action="{{ route('register') }}" class="sign-up-form">
                    ...
                    <div class="input-field">
                        ...
                        <input id="cpf" class="form-control @error('cpf') is-invalid @enderror" name="cpf"
                            value="{{ old('cpf') }}" required autocomplete="cpf" type="text" placeholder="CPF"
                    ...
                    <div class="input-field">
                        ...
                        <input id="phone" class="form-control @error('phone') is-invalid @enderror" name="phone"
                            value="{{ old('phone') }}" required autocomplete="phone" type="text" type="tel"
                            placeholder="Telefone" onkeypress="$(this).mask('(00) 0000-00009')" />
                    </div>

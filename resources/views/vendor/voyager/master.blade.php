...
<head>
    ...
    <!-- App CSS -->
    <link rel="stylesheet" href="{{ asset('assets-voyager/css/app.css') }}">

    @yield('css')
    @if(__('voyager::generic.is_rtl') == 'true')
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-rtl/3.4.0/css/bootstrap-rtl.css">
    <link rel="stylesheet" href="{{ asset('assets-voyager/css/rtl.css') }}">
    @endif
...
<body class="voyager @if(isset($dataType) && isset($dataType->slug)){{ $dataType->slug }}@endif">
    ...
    <script type="text/javascript" src="{{ asset('assets-voyager/js/app.js') }}"></script>

    <script>
        @if(Session::has('alerts'))
        let alerts = {
            !!json_encode(Session::get('alerts')) !!
        };
        ...
        var alertType = {
            !!json_encode(Session::get('alert-type', 'info')) !!
        };
        var alertMessage = {

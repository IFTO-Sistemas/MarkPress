            ...
            <div class="collapse navbar-collapse" id="navbarExample01">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item active">
                        <a class="nav-link text-white" aria-current="page" href="http://localhost/#inicio">Inicio</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="http://localhost/#palestras" rel="nofollow">Palestras</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="http://localhost/#final">Contatos</a>
                    </li>
                </ul>
